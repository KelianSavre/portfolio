import '../stylesheets/about-me/about-me.css'


export default function AboutMe(){
    return(
        <section className="aboutMe" id="anchor-introduction">
            <div className="aboutMe-content">

                <p className='aboutMe-welcome'>Bienvenue,</p>
                <h1>Je suis <strong>Kélian</strong>
                    <br/>
